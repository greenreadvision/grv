...
class Fitness_Insight_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'fitness-insight' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $fitness_insight_font_awesome_icon_array = fitness_insight_font_awesome_icon_array();
                    foreach ($fitness_insight_font_awesome_icon_array as $fitness_insight_font_awesome_icon) {
                            $icon_class = $this->value() == $fitness_insight_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($fitness_insight_font_awesome_icon).'"></i>
                            <span class="fitness-insight-social-class">'.esc_attr($fitness_insight_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function fitness_insight_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'fitness-insight-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'fitness_insight_customizer_script' );

if(!function_exists('fitness_insight_font_awesome_icon_array')){
    function fitness_insight_font_awesome_icon_array(){
