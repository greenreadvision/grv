...
class BillPayment extends Model
{
    ...
    protected $fillable = ['payment_id','user_id','intern_name','project_id','remittancer','bank','title','content','receipt','receipt_date','receipt_number','price','receipt_file','detail_file','status','matched','managed','number','finished_id','review_date'];
