...
class TrainController extends Controller
{
    ...
    public function activeTrain(){
        return view('pm.train.activeTrain');
    }

    public function activeTest(){
        $questions = Question::inRandomOrder()->where('type','=','active')->get();
        return view('pm.train.test')->with('data',$questions);
    }
    ...
    public function activeReview(Request $request){
        ...
        foreach($questions as $data){
            ...
            if($answer == $data->answer)
            {
                ...
                array_push($corrects,Question::find($data->question_id));
            }
            else
            {
        ...
        return view('pm.train.result',['grade'=>$grade,'fail'=>$total,'href'=>$href,'corrects'=>$corrects]);
    }
    
    
    public function pmTrain(){
        return view('pm.train.pmTrain');
    }
    ...
    {
        \Auth::user()->update(['status' => "train_OK"]);
