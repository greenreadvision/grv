...
<div class="d-flex justify-content-center">
    <div class="col-lg-8">
        <div class="card border-0 shadow rounded-pill">
            <div class="card-body">
                <div class="col-lg-12">
                    <form id="formType" action="/group/create/review" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col">
                            ...
                            <div class="form-row" id="item_all">
                                <div class="col-lg-6">
                                    ...
                                    <select type="text" id="item_type" name="item_type" class="form-control rounded-pill" onchange="changeItem(this.options[this.options.selectedIndex].value)" disabled>
                                        <option value=""></option>
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    ...
                                    <input autocomplete="off" type="text" id="name" name="name" class="form-control rounded-pill"  value="{{ old('name') }}" required/>
                                </div>
                                <div class="col-lg-6">
                                    <label for="webAddress" class="col-form-label" >網站</label>
                                    <input autocomplete="off" type="text" id="webAddress" name="webAddress" class="form-control rounded-pill"  value="{{ old('webAddress') }}" />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <label for="phone" class="col-form-label"><b style="color:green">*</b>室話</label>
                                    <input autocomplete="off" maxlength="15" type="text" id="phone" name="phone" class="form-control rounded-pill" onchange="checkPhone()" value="{{ old('phone') }}" required/>
                                </div>
                                <div class="col-lg-4">
                                    <label for="telephone" class="col-form-label"><b style="color:green">*</b>手機</label>
                                    <input autocomplete="off" maxlength="10" type="text" id="telephone" pattern="[0-9]{10}"  name="telephone" onchange="checkPhone()" class="form-control rounded-pill" value="{{ old('telephone') }}"/>
                                </div>
                                <div class="col-lg-4">
                                    <label for="fax" class="col-form-label">傳真(選填)</label>
                                    <input autocomplete="off" maxlength="15" type="text" id="fax" name="fax" class="form-control rounded-pill" value="{{ old('fax') }}"/>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div id="createNewActive" style="display: none">
                                <div class="form-row">
                                    <div class="col-lg-4">
                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" id="simple_content" name="simple_content" class="form-control rounded-pill" required/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <label class="label-style col-form-label" for="content"> 詳細介紹</label>
                                    <textarea id="content" name="content" rows="5" style="resize:none;" class="form-control rounded-pill{{ $errors->has('content') ? ' is-invalid' : '' }}" ></textarea>
                                </div>
                            </div>
                        </div>
                        <div >
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-green rounded-pill"><span class="mx-2">整體新增</span> </button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function setData(i){
        list = "<tr>" +
            ...
            "<td width='45%  style='margin-bottom: 0'><input type='text' name='activeName-"+i+"' value = '"+activeName[i]+"' class='form-control rounded-pill' readonly></td>" +
            "<td width='10%'></td>"
            "<tr>"
